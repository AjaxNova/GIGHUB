                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: IconButton(
                                    onPressed: () {
                                      setState(() {
                                        if (skillsMap.containsKey(
                                            _skillContoller.text)) {
                                          Utils().showSnackBarMessage(
                                              context: context,
                                              content: 'skill already exist');
                                        } else {
                                          skillsMap[_skillContoller.text] = '';
                                        }
                                      });

                                      _skillContoller.clear();
                                    },
                                    icon: const Icon(Icons.add_box, size: 42),
